...
namespace MSHB.StockAssistanceProvider.Presentation.WebUI.filters
{
    public class ValidateModelAttribute : ActionFilterAttribute
    {
        ...
        private List<StockAssistanceProviderErrorMessage> GetModelStateDetailErrors(ModelStateDictionary modelState, string errorCode)
        {
            List<StockAssistanceProviderErrorMessage> modelErrors = new List<StockAssistanceProviderErrorMessage>();
            if (modelState.Keys.Any())
            {
                ...
                foreach (var stateKey in keys)
                {
                    ...
                    {
                        modelErrors.Add(new StockAssistanceProviderErrorMessage(errorCode, error.ErrorMessage));
                    }
                }
            }
            return modelErrors;
