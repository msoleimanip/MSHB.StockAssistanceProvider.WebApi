...
namespace MSHB.StockAssistanceProvider.Layers.L03_Services.Impls
{
    ...
    public class TokenStoreService : ITokenStoreService
    {
        ...
        private readonly StockAssistanceProviderDbContext _uow;
        ...
        public TokenStoreService(
            StockAssistanceProviderDbContext uow,
        ...
        public Task<UserToken> FindTokenLoginAsync(string refreshToken)
        {
            ...
            {
                throw new StockAssistanceProviderGlobalException(UsersServiceErrors.RefreshToken);
            }
        ...
        private async Task<string> CreateAccessTokenAsync(User user)
        {
            var claims = new List<Claim>
            {
                ...
                new Claim("AvailableUserType", user.AvailableUserType.ToString()),
